...
class CompanyProfile(TimeStampedModel):
    ...
    phone_primary = models.CharField(max_length=50, blank=True, default="+966 50 969 6018")
    phone_secondary = models.CharField(max_length=50, blank=True, default="+966 54 004 8692")
