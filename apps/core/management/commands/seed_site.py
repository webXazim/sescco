...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        project_page_settings = up(ProjectListPageSettings, {'id':1}, eyebrow='Project Experience', hero_title='Proven Project Experience Across Saudi Arabia', hero_subtitle='SESCCO’s portfolio includes electrical, telecommunication, civil, architectural fit-out, pipeline, mechanical and support projects.', intro_title='Experience that reflects execution capability.', intro_text=p('Our project experience demonstrates the ability to work across industrial, utility and commercial environments.'), show_category_tabs=True)
        ...
        projects=[
            ...
            ('Ethernet Cable Installation and Testing Works','Telecommunication Projects','Industrial Client','SESCCO Team','Saudi Arabia','completed',2025,'Completed','Ethernet cable preparation, installation, labeling and testing support for low-current project requirements.'),
            ('Telecommunication Cabinet and Network Support Works','Telecommunication Projects','SEPCO','SESCCO Team','Saudi Arabia','completed',2025,'Completed','Telecommunication cabinet, panel and network support works with site coordination and quality checks.'),
            ('SEPCO Telecommunication Field Support Works','Telecommunication Projects','SEPCO','SESCCO Team','Saudi Arabia','completed',2025,'Completed','Telecommunication field support, inspection assistance and installation coordination for project delivery.'),
            ('OPGW Fiber Splicing and Testing Works','Telecommunication Projects','SEPCO','SESCCO Team','Saudi Arabia','completed',2025,'Completed','OPGW fiber splicing, testing and technical support works for telecommunication infrastructure.'),
